(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function viewSource(source, sourceHeader, sourceFooter, mode) {
      // In order to render in rstudio IDE -> separate html string
      // see : https://github.com/vegawidget/altair/issues/11
        var header = "<html><h" + "ead>" + sourceHeader + "</h" + "ead><body><pre><code class=\"json\">";
